    ...
    <Section crosses >
            <div className='container lg:flex'>
                <div className='max-w-[25rem]'>
                    <h2 className='h2 mb-4 md:mb-8'>AI Chat App for Seamless Collab</h2>
            ...
            <Button>Try It Now</Button>
                ...
                <div className='lg:ml-auto xl:w-[38rem]'>
                    <p className='body-2 mb-10 text-n-4 mt-2
                    md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto'>{collabText}</p>
                                ...
                                {collabApps.map((app, index) => (
                                        ...
                                        >
                                            <div className={`relative -top-[1.6rem]
                                                flex w-[3.2rem] h-[3.2rem]
                                                bg-n-7 border border-n-1/15 rounded-xl
                                                -rotate-${index*45}`}>
                                                <img 
                                                src={app.icon}
                                                className='m-auto'
